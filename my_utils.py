##################################################################################################################
## I built on top of the examples file provided in the innvestigate lib and added my own functions
##################################################################################################################
...
def plot_image_grid_final(grid,
                          ...
                          col_labels,
                          file_name=None, 
                          scale=1, ## Select a smaller value (say 0.8 to have colorbar)
                          ):
